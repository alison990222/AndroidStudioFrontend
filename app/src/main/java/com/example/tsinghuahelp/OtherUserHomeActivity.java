...
public class OtherUserHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pro_num).setVisibility(View.GONE);
        findViewById(R.id.follower_num).setVisibility(View.GONE);
        findViewById(R.id.follow_num).setVisibility(View.GONE);
        findViewById(R.id.edit_info_btn).setVisibility(View.GONE);
        other_username=findViewById(R.id.info_username);
        is_verify=findViewById(R.id.is_verify);
        btn_verify=findViewById(R.id.info_verify);
